...
{\HUGE Crystallisation and Confinement of Mesoscale Active Matter }\\[4mm]
...
\vspace{11mm}
\begin{minipage}{10cm}
A dissertation submitted to the University of Bristol in accordance with the requirements of the degree of \textsc{Doctor of Philosophy} in the Faculty of Physics.
\end{minipage}\\
\vspace{9mm}
{\large\textsc{\today}}
\vspace{12mm}
